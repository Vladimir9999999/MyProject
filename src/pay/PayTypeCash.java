...
public class PayTypeCash implements Pay {

    private WebApplicationContext ctx;

    private float prepaySumm = 0F;
    private int currency = EntityBills.PAY_METHOD_CASH;
    ...
    public PayTypeCash(WebApplicationContext ctx, long shopId, long userId, float prepaySumm) {
